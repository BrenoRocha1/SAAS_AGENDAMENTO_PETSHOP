...
export default function CompletarCadastroLojistaPage() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      const result = await completarCadastroLojistaGoogleAction(new FormData(form))
    ...
    return (
      <div className="login-shell" style={{ gridTemplateColumns: '1fr' }}>
        <div className="login-form-pane">
          <div className="login-form-inner" style={{ maxWidth: 520, textAlign: 'center' }}>
      ...
      <div className="login-form-pane">
        <div className="login-form-inner" style={{ maxWidth: 520 }}>
          ...
          <p className="login-sub">
            Preencha os dados do seu estabelecimento para começar a receber agendamentos.
          </p>
          ...
          <form className="login-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="login-field">
              <label htmlFor="descricao" className="login-label">Descrição <span style={{ fontWeight: 400, color: 'var(--lg-ink-mute)' }}>(opcional)</span></label>
